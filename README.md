...
4. When the script completes, wait a few minutes and then reload the Developer Catalog in your cluster console.  Search on 'IBM' to find the newly installed starter kits. 
